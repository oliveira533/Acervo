...
<html>
    ...
    <body>
        ...
        <div class="Musica tudo">
            <label class="Titulo">Músicas que você cadastro</label><br>
            <div class="card">
                <img src="#"><br>
                <label>Musica</label>
            </div>        
        ...
        <div class="Banda tudo">
            <label class="Titulo">Bandas que você cadastro</label><br>
            <div class="card">
                <img src="#"><br>
                <label>Banda</label>
            </div>        
        ...
        <div class="Album tudo">
            <label class="Titulo">Albuns que você cadastro</label><br>
            <div class="card">
                <img src="#"><br>
                <label>Album</label>
            </div>        
